 ...
 * within this plugin.
 */
class IOpenXRHandTrackingCrossPlatformModule : public IInputDeviceModule
{
public:
	/**
	...
	*/
	static inline IOpenXRHandTrackingCrossPlatformModule& Get()
	{
		return FModuleManager::LoadModuleChecked<IOpenXRHandTrackingCrossPlatformModule>("OpenXRHandTrackingCrossPlatform");
	}
	...
	*/
	...
	{
		return FModuleManager::Get().IsModuleLoaded("OpenXRHandTrackingCrossPlatform");
	}
	...
	/**
	* Returns the LiveLinkSource associated with this OpenXRHandTrackingCrossPlatformPlugin.
	*
	* @return Shared pointer to the Input Device.
	*/
